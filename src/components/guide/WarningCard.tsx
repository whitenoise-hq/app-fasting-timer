  ...
  return (
    <View className="bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-800 rounded-2xl p-4">
      <View className="flex-row items-center mb-3">
        <View className="w-8 h-8 bg-amber-100 dark:bg-amber-800 rounded-full items-center justify-center mr-2">
        ...
        <Text className="text-base font-bold text-amber-800 dark:text-amber-200 flex-1">
          {warning.title}
        </Text>
      </View>
